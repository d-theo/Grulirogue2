...
export const Potions = {
  ...
  Dodge: {
    ...
    effect: (t: Hero) =>
      t.addBuff(
        Buff2.create(() => Conditions.dodge({ dodgeBonus: 0.3 })).setTurns(15)
      ),
  },
  Blindness: {
    ...
    effect: (t: Hero) =>
      t.addBuff(
        Buff2.create(() => Conditions.blind({ sightMalus: 6 })).setTurns(15)
      ),
  },
  Immobilisation: {
  ...
  Accuracy: {
    ...
    effect: (t: Hero) =>
      t.addBuff(Buff2.create(Conditions.accurate).setTurns(15)),
  },
  Speed: {
  ...
  Rage: {
    ...
    effect: (t: Hero) =>
      t.addBuff(Buff2.create(() => Conditions.rage({})).setTurns(15)),
  },
  Berkserk: {
    ...
    effect: (t: Hero) =>
      t.addBuff(Buff2.create(Conditions.berserk).setTurns(15)),
  },
  Curring: {
    name: "Potion of curring",
    description: "A potion that cure all the magic",
    effect: (t: Hero) => {
      const clean = SpellMaker.createSpell(
        SpellNames.CleaningSpell
      ) as CleaningEffect;
      clean.cast(t);
    },
  },
