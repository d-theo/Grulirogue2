      ...
      for (var y = 0; y < adjRooms.length; y++) {
        ...
        switch (direction) {
          ...
          case 'down':
            ...
            if (
              point.x === _center.x + currentRoomData.rect.width / 2 ||
              point.x === _center.x - currentRoomData.rect.width / 2
            ) {
            ...
            var X = Math.floor(
              point.x - _center.x < 0
                ? adjRooms[y].gameMetadata.rect.width / 2
                : -(adjRooms[y].gameMetadata.rect.width / 2)
            );
            var Y = Math.floor(
              point.y - _center.y < 0
                ? adjRooms[y].gameMetadata.rect.height / 2
                : -(adjRooms[y].gameMetadata.rect.height / 2)
            );
            line = {
          ...
          case 'left':
            ...
            if (
              point.y === _center.y + currentRoomData.rect.height / 2 ||
              point.y === _center.y - currentRoomData.rect.height / 2
            ) {
              throw new Error('nope');
            }
