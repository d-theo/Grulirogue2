  ...
  for (const add of additional) {
    switch (add.type) {
      case "snakeBoss":
        ...
        const king = monsterFactory.createMonster(
          Object.assign(m, { pos: add.pos })
        );
      ...
      case "monster":
        ...
        const snake = Monster.makeMonster(
          Object.assign(_snake, { pos: add.pos })
        );
      ...
      case "crab":
        ...
        const _crab = Monster.makeMonster(
          Object.assign(crab, { pos: add.pos })
        );
        monsterCollection.monstersArray().push(_crab);
        break;
      case "crabBoss":
        let crabBoss = Bestiaire.Pirate.CrabBoss;
        const _crabBoss = Monster.makeMonster(
          Object.assign(crabBoss, { pos: add.pos })
        );
